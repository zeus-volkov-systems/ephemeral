...
"""
import ephemeral.tasks.src.main.xarray.tasks as tasks
from ephemeral.tasks.src.main.xarray.statistics.task_factory import (
    get_task as get_statistic_task)

def make_task_dict():
    """Defines the routing for this task order.
    """
    task_dict = {}
    task_dict["statistics"] = get_statistic_task
    return task_dict
