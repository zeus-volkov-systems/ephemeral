...
"""
import ephemeral.tasks.src.main.strings.tasks as tasks
from ephemeral.tasks.src.main.strings.operations.task_factory import (
    get_task as get_operations_task)
...
def make_task_dict():
    ...
    """
    task_dict = {}
    task_dict["operations"] = get_operations_task
    return task_dict
